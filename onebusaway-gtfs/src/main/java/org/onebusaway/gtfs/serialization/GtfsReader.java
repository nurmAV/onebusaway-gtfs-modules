...
public class GtfsReader extends CsvEntityReader {
  ...
  public GtfsReader() {
    ...
    _entityClasses.add(FareCapping.class);
  ...
  private class EntityHandlerImpl implements EntityHandler {
    ...
    public void handleEntity(Object entity) {
      ...
      } else if(entity instanceof Timeframe) {
        Timeframe timeframe = (Timeframe) entity;
        registerAgencyId(Timeframe.class, timeframe.getId());
